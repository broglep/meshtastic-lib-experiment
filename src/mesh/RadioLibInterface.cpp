...
RadioLibInterface::RadioLibInterface(LockingArduinoHal *hal, RADIOLIB_PIN_TYPE cs, RADIOLIB_PIN_TYPE irq, RADIOLIB_PIN_TYPE rst,
    ...
    : /*concurrency::NotifiedWorkerThread("RadioIf"),*/ module(hal, cs, irq, rst, busy), iface(_iface)
{
    instance = this;
...
void RadioLibInterface::notifyLater(unsigned long i, RadioLibInterface::PendingISR isr, bool b) {

}

void RadioLibInterface::notifyFromISR(BaseType_t *pInt, RadioLibInterface::PendingISR isr, bool b) {
