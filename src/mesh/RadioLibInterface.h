...
class RadioLibInterface : public RadioInterface, protected concurrency::NotifiedWorkerThread
{
    ...
    MeshPacketQueue txQueue; // = MeshPacketQueue(MAX_TX_QUEUE, nodeId);
    NodeNum *nodeId;
    meshtastic_Config_DeviceConfig *deviceConfig;
  ...
  public:
    RadioLibInterface(LockingArduinoHal *hal, RADIOLIB_PIN_TYPE cs, RADIOLIB_PIN_TYPE irq, RADIOLIB_PIN_TYPE rst,
                      RADIOLIB_PIN_TYPE busy, PhysicalLayer *iface = NULL, NodeNum *_nodeId = NULL, meshtastic_Config_DeviceConfig *_deviceConfig = NULL);
  ...
  protected:
    ...
    bool _isFromUs(meshtastic_MeshPacket *pPacket);
};